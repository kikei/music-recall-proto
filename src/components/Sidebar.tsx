...
export function Sidebar({
  ...
  useEffect(() => {
    if (recallQuery !== null) setQuery(recallQuery);
  }, [recallQuery]);
      ...
      <aside className="sidebar">
        <div className="brand">
          ...
          <NavLink
            ...
            to={{ kind: 'new', projectSlug: currentProject.slug }}
            title="新しいセッション"
            aria-label="新しいセッション"
          />
        </div>
          ...
          <div className="side-section">
            ...
            {recentCards.map(c => (
              <NavLink
                ...
                to={{ kind: 'card', projectSlug: c.projectSlug, id: c.id }}
            ...
            <NavLink
              ...
              to={{ kind: 'cards', projectSlug: currentProject.slug }}
            >
              すべてのカード
